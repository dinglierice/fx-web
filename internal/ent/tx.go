...
func (tx *Tx) init() {
	tx.PsConfig = NewPsConfigClient(tx.config)
	tx.PsStrategy = NewPsStrategyClient(tx.config)
...
// applies a query, for example: PsConfig.QueryXXX(), the query will be executed
